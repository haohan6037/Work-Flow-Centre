using ProcessCentre.Application.Common.Models;
using ProcessCentre.Application.TodoItems.Commands.CreateTodoItem;
using ProcessCentre.Application.TodoItems.Commands.DeleteTodoItem;
using ProcessCentre.Application.TodoItems.Commands.UpdateTodoItem;
using ProcessCentre.Application.TodoItems.Commands.UpdateTodoItemDetail;
using ProcessCentre.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace ProcessCentre.Web.Endpoints;
